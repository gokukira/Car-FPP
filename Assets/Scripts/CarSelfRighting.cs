...
namespace UnityStandardAssets.Vehicles.Car
{
    public class CarSelfRighting : MonoBehaviour
    {
        ...
        [SerializeField] private float m_WaitTime = 0.2f;           // time to wait before self righting
        [SerializeField] private float m_VelocityThreshold = 0.2f;  // the velocity below which the car is considered stationary for self-righting
